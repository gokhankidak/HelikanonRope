...
public class RopeControllerSimple : MonoBehaviour
{
    ...
    public void CreateRope()
    {
        ...
        fromTheRope.GetComponent<Rigidbody>().mass = loadMass;
        _isActive = true;
    }
    ...
    private void DisplayRope()
    {
        ...
        Vector3 D = fromTheRope.position;
        ...
        //Lower control point
        Vector3 C = D + fromTheRope.up * ((A - D).magnitude * 0.5f);
